...
import 'package:cinema_app/models/movietime.model.dart';
...
class Utils {
  static List<MovieModel> getMovies() {
    ...
    for (int i = 0; i < 5; i++) {
      String formattedHour = currentDate.hour % 12 == 0
          ? '12'
          : (currentDate.hour % 12).toString();
      String formattedTime =
          formattedHour + ":00 " + (currentDate.hour < 12 ? "AM" : "PM");
    ...
    var movieList = [
        ...
        cast: [
          {
            ...
            "movieName": "Director",
            "image": "assets/imgs/actor_1.png",
          },
          {
            "orginalName": "Matt   Damon  ",
            "movieName": "Carroll",
            "image": "assets/imgs/actor_2.png",
          },
          {
            "orginalName": "Christian Bale",
            "movieName": "Ken Miles",
            "image": "assets/imgs/actor_3.png",
          },
          {
            "orginalName": "Caitriona Balfe",
            "movieName": "Mollie",
            "image": "assets/imgs/actor_4.png",
          },
        ],
      ),
      MovieModel(
        ...
        description:
            "After five years of marriage Ruth and Brandon seek to spice up their marriage, just not with each other. Brandon through addiction, and Ruth with a coworker. Will they be able to come back or will their marriage asunder?",
      ...
      MovieModel(
        imgPath:
            './assets/imgs/movies/daisy-quokka-world-s-scariest-animal-12101127.jpeg',
      ...
      MovieModel(
        imgPath:
            './assets/imgs/movies/finding-love-in-mountain-view-12101114.jpeg',
      ...
      MovieModel(
        ...
        castInfo:
            "Bryce McLaughlin, Elysia Rotaru, William 'Big Sleeps' Stewart",
        ratedInfo: "TV-14",
        duration: "01:25:00",
        rating: "7.5",
        year: "2022",
      ...
      MovieModel(
        imgPath:
            './assets/imgs/movies/hawk-and-rev-vampire-slayers-12101086.jpeg',
      ...
      MovieModel(
        ...
        description:
            "Nest of Vampires follows an MI5 agent who travels from London to rural England in search of the people who murdered his wife and kidnapped his only daughter.",
      ...
      MovieModel(
        ...
        castInfo:
            "Laura Vandervoort, Nicholas Gonzalez, Mia Quaranta de la Rosa",
        ratedInfo: "TV-G",
        duration: "01:24:00",
        rating: "7.5",
        year: "2022",
      ...
      MovieModel(
        ...
        title: "Someday Isles",
        description:
            "'Someday Isles' is a Feature Film detailing the chaotic journey of PayAttenion coming to terms with his life's purpose by embracing his destiny through self-actualization.",
      ...
      MovieModel(
        ...
        description:
            "The Book of Job is about a high school student who has trouble separating reality from fiction. Young Job falls 'madly in love' with a new girl who catches his eye one Sunday mass",
      ...
      MovieModel(
        imgPath:
            './assets/imgs/movies/the-incredible-25th-year-of-mitzi-bearclaw-12101129.jpeg',
      ...
      MovieModel(
        ...
        title: "The Widow",
        description:
            "In a densely forested area north of St. Petersburg people have been going missing for three decades.The few corpses ever found were naked.",
      ...
      MovieModel(
        imgPath:
            './assets/imgs/movies/v-c-andrews-all-that-glitters-12101147.jpeg',
        title: "V. C. Andrews' All that Glitters",
        description:
            "All That Glitters picks up as Ruby is driven from the Dumas mansion and returns to her beloved childhood home in the bayou where she's intent on creating a new life for her baby daughter, Pearl.",
      ...
      MovieModel(
        imgPath:
            './assets/imgs/movies/zack-snyder-s-justice-league-12101097.jpeg',
    ...
    movieList.forEach((MovieModel movieModel) {
      ...
      movieModel.duration = parsedDuration.hour.toString() +
          ' hr. ' +
          parsedDuration.minute.toString() +
          ' min.';
    });
